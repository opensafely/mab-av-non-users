...
# - 'trt_grp'_'adjustment_set'_overlap_plot_day5_before_restriction_haem_malig_new.png
# - 'trt_grp'_'adjustment_set'_overlap_plot_day5_after_restriction_haem_malig_new.png
...
# - 'trt_grp'_'outcomes'_'adjustment_set'_cumInc_day5_haem_malig_new.png
# [note, if script is run for day5 and day0, file with cumInc plots will be 
# overwritten (and named 'day5' in both instances)]
# 3. Tables with effect estimates in ./output/tables:
# - cox_models_'data_label'_'adjustment_set'_haem_malig_new.csv
# 4. Log file with errors and warnings in ./output/tables:
# - log_cox_models_'data_label'_'adjustment_set'_haem_malig_new.csv
# 5. PS models in ./output/data_models:
# - 'trt_grp'_'adjustment_set'_psModelFit_haem_malig_new.rds
...
# - counts_n_'data_label'_crude_haem_malig.csv
# - counts_n_outcome_'data_label'_crude_haem_malig.csv
# - counts_n_restr_'data_label'_'adjustment_set'_haem_malig.csv 
# - counts_n_outcome_restr_'data_label'_'adjustment_set'_haem_malig.csv
    ...
    saveRDS(psModel,
            here("output", 
                 ...
                 paste0(trt_grp[i],
                        "_",
                        adjustment_set,
                        "_psModelFit_haem_malig_new.rds")
            )
    )
           ...
           filename = 
             here("output", "figs", 
                  paste0(trt_grp[i],
                         "_",
                         adjustment_set,
                         "_overlap_plot_day5_before_restriction_haem_malig_new.png")),
           ...
           filename = 
             here("output", "figs", 
                  paste0(trt_grp[i],
                         "_",
                         adjustment_set,
                         "_overlap_plot_day5_after_restriction_haem_malig_new.png")),
           width = 20, height = 14, units = "cm")
    ############################################################################
    # A.2.5 Outcome model
    ############################################################################
               ...
               filename = 
                 here("output", "figs", 
                      paste0(trt_grp[i],
                             ...
                             "_",
                             adjustment_set,
                             "_cumInc_day5_haem_malig_new.png")),
               width = 20, height = 14, units = "cm")
