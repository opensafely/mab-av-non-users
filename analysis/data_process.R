  ...
  mutate(
   ...
   sgtf = fct_case_when(
    ...
    tb_postest_vacc = ifelse(!is.na(date_most_recent_cov_vac),
                             difftime(date_most_recent_cov_vac, covid_test_positive_date, units = "days") %>% as.numeric() %>% abs(), 
                             NA_integer_),
    ...
    tb_postest_treat = ifelse(!is.na(date_treated), 
                              difftime(date_treated, covid_test_positive_date, units = "days") %>% as.numeric() %>% abs(), 
                              NA_integer_),
