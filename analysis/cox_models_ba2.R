...
# - 'trt_grp'_'adjustment_set'_overlap_plot_day5_before_restriction_ba2_new.png
# - 'trt_grp'_'adjustment_set'_overlap_plot_day5_after_restriction_ba2_new.png
...
# - log_cox_models_'data_label'_'adjustment_set'_ba2_new.csv
# 5. PS models in ./output/data_models:
# - 'trt_grp'_'adjustment_set'_psModelFit_ba2_new.rds
# [note, if script is run for day5 and day0, file with ps model will be 
# overwritten]
# 6. CSV files with counts (redacted)
# - counts_'data_label'_'adjustment_set'_ba2.csv
#
           ...
           filename = 
             here("output", "figs", 
                  paste0(trt_grp[i],
                         "_",
                         adjustment_set,
                         "_overlap_plot_day5_before_restriction_ba2_new.png")),
           ...
           filename = 
             here("output", "figs", 
                  paste0(trt_grp[i],
                         "_",
                         adjustment_set,
                         "_overlap_plot_day5_after_restriction_ba2_new.png")),
           width = 20, height = 14, units = "cm")
    ############################################################################
    # A.2.5 Outcome model
    ############################################################################
