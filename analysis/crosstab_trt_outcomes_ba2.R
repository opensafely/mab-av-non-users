...
# load data
data_cohort_day5 <- 
  read_rds(here("output", "data", "ba2_data_processed_day5.rds"))
data_cohort_day0 <-
  read_rds(here("output", "data", "ba2_data_processed_day0.rds"))
data_cohort_day0_4 <-
  data_cohort_day0 %>%
...
summarise_outcomes(data_cohort_day5, 
                   fu_primary, 
                   status_primary,
                   "ba2_day5_primary.csv")
cat("\n#### cohort day 5-27, secondary outcome ####\n")
summarise_outcomes(data_cohort_day5, 
                   fu_secondary, 
                   status_secondary,
                   "ba2_day5_secondary.csv")
...
summarise_outcomes(data_cohort_day0, 
                   fu_primary, 
                   status_primary,
                   "ba2_day0_primary.csv")
cat("\n#### cohort day 0-27, secondary outcome ####\n")
summarise_outcomes(data_cohort_day0, 
                   fu_secondary, 
                   status_secondary,
                   "ba2_day0_secondary.csv")
...
summarise_outcomes(data_cohort_day0_4, 
                   fu_primary, 
                   status_primary,
                   "ba2_day0_4_primary.csv")
cat("\n#### cohort day 0-4, secondary outcome ####\n")
summarise_outcomes(data_cohort_day0_4, 
                   fu_secondary, 
                   status_secondary,
                   "ba2_day0_4_secondary.csv")
...
# Save flowcharts
write_csv(flowchart, path(here("output", "data_properties", "flowchart_ba2.csv")))
write_csv(flowchart_redacted, path(here("output", "tables", "flowchart_redacted_ba2.csv")))
