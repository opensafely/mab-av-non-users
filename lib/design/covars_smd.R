covars_smd <- 
  c("age",
    ...
    "region_nhs_london",
    "region_nhs_east",
    "region_nhs_east_midlands",
    "region_nhs_north_east",
    "region_nhs_north_west",
    "region_nhs_south_east",
    "region_nhs_south_west",
    "region_nhs_west_midlands",
    "region_nhs_yorkshire_humber",
